...
public class Library {
	...
	public static void main(String[] args) {
		if (args.length != 3) {
			System.err.println("Usage: java Library <num_floors> <num_students> <num_tables>");
			System.exit(1);
		}

		Library l1 = new Library(Integer.parseInt(args[0]), Integer.parseInt(args[1]), Integer.parseInt(args[2]));
	}
